...
function Team() {
    return(
        <section className="team mt-10">
            <h2 className="text-3xl text-center font-bold">Conoce a Nuestro Equipo</h2>
            <div className="team-container mt-8 grid grid-cols-1 sm:grid-cols-2 gap-10 px-4"> 
                <div className="team-member text-center">
                  <h3 className="text-xl font-semibold">Esteban Pizarro</h3>
                  <p className="text-lg text-gray-500 mt-2">CEO | Desarrollador Web</p>
