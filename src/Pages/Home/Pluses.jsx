...
function Pluses () {
    return (
        <section className="pt-6 ml-5 mr-5 pb-6">
            <h2 className="text-center font-bold text-3xl mt-4">Nuestras Caracteristicas</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-5 md:gap-y-16">
              ...
              <h4 className="font-bold text-xl">Amplia seleccion</h4>
              <span>Miles de productos para elegir</span>
              </div>
              ...
              <h4 className="font-bold text-xl">Envio Rapido</h4>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-credit-card w-10 h-10 text-blue-500"><rect width="20" height="14" x="2" y="5" rx="2"></rect><line x1="2" x2="22" y1="10" y2="10"></line></svg>
                ...
                <span>Transaccions 100% seguras</span>
              </div>
              ...
              <h4 className="font-bold text-xl">Atencion al cliente</h4>
